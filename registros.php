...
<br>
    ...
    <label for="clave">Nombre que desea eliminar:</label>
    <input  type="text" name="clave" placeholder="Nombre que desea eliminar" >
    <label for="contra">Contraseña</label>
    <input  type="text" name="contra" placeholder="Contraseña" >
    <input class="eliminar" type="submit" value="Eliminar Nombre" name="btneliminar">
